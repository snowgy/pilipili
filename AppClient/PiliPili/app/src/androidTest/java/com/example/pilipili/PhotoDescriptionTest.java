...
public class PhotoDescriptionTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    /* When user click the photo, a page of description of the photo will display. */
    @Test
    public void photoDescriptionTest() {
    ...
    /* In photo description page, back to Home page when user click the Home button. */
    @Test
    public void photoDescriptionTest0() {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.user_name),
                        childAtPosition(
                                childAtPosition(
